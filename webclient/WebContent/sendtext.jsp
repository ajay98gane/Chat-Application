<%@ page import="java.sql.*" language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%> <%@page import="webclient.*" %> <%@page import="java.util.*" %><%@page import="org.json.*" %>
...
<div>
            ...
            <textarea id="displaymsg"rows="10" cols="100" style="width: 800px;height: 400px;font-size:20px;background:#ccf5ff;color: #0436af;position: relative;">
